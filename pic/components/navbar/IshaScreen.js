...
Ensure that water reaches all parts of the feet, including between the toes.
      ...
      case 2:
        return (
          ...
          <ScrollView style={styles.scrollView}>
            <View style={styles.stepContainer}>
              <Text style={styles.text}>Step 1: Night Prayer (Salat al-‘Isha)</Text>
              <Text style={styles.description}>
              It is then rakahs in total. First, the four first sunnah rakahs, then four obligatory rakahs, and then two last sunnah rakahs are performed. After the Night Prayer, three rakahs Odd-Numbered Prayer (Salat al-Witr) is performed. The latter is wajib.
              </Text>
            </View>
...
I intend to offer the _____ rakats of the ____ prayer. So you could say something along the lines, “I intend to offer the 4 rakats fardh of the Isha prayer” .Standing Straight.
              </Text>
