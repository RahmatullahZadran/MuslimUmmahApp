...
Ensure that water reaches all parts of the feet, including between the toes.
      ...
      case 2:
        return (
          ...
          <ScrollView style={styles.scrollView}>
            <View style={styles.stepContainer}>
              <Text style={styles.text}>Step 1: Noon Prayer (Salat al-Zuhr)</Text>
              <Text style={styles.description}>
              It is ten rakahs in total. First, four first sunnah rakahs, and then four obligatory rakahs, and at the end, two last sunnah rakahs are performed.This will only focus on the obligatory/fardh prayers.
              </Text>
            </View>
...
I intend to offer the _____ rakats of the ____ prayer. So you could say something along the lines, “I intend to offer the 4 rakats fardh of the Zuhr prayer” .Standing Straight.
              </Text>
