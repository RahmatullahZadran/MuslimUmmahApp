...
Ensure that water reaches all parts of the feet, including between the toes.
      ...
      case 2:
        return (
          ...
          <ScrollView style={styles.scrollView}>
            <View style={styles.stepContainer}>
              <Text style={styles.text}>Step 1: Morning Prayer (Dawn Prayer, Salat al-Fajr)</Text>
              <Text style={styles.description}>
              The Morning Prayer is composed of four units (rakahs); two sunnah rakahs and two obligatory (fardh) rakahs. First the sunnah rakahs and then the obligatory rakahs are performed.This will only focus on the obligatory/fardh prayers.
              </Text>
            </View>
...
I intend to offer the _____ rakats of the ____ prayer. So you could say something along the lines, “I intend to offer the 2 rakats fardh of the Fajr prayer” .Standing Straight.
              </Text>
      ...
      case 3:
        return (
          ...
          <ScrollView style={styles.scrollView}>
            ...
            <View style={styles.stepContainer}>
              <Text style={styles.text}>Step 10:Ending the 2 rakats</Text>
              <Text style={styles.description}>
      ...
      case 4:
        return (
          ...
          <ScrollView>
            <View style={styles.container}>
              <Text style={styles.title}>Full 2 Rakat Prayer Example</Text>
              <Text style={styles.description}>
                This is an example of the full 2 rakat prayer. with different quran passages.
              </Text>
              <Button title="Play Audio" onPress={prayer13} />  
            </View>
          </ScrollView>
            <Button title="Previous" onPress={() => setStep(step - 1)} />
          </View>
