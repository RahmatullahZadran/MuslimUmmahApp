...
const MaghribScreen = () => {
  ...
  const prayer15 = async () => {
    try {
      const { sound } = await Audio.Sound.createAsync(
        require('../audio/prayer15.mp3')
      );
      setSound(sound);
      await sound.playAsync();
    } catch (error) {
...
Ensure that water reaches all parts of the feet, including between the toes.
      ...
      case 2:
        return (
          ...
          <ScrollView style={styles.scrollView}>
            <View style={styles.stepContainer}>
              <Text style={styles.text}>Step 1:  Sunset Prayer (Salat al-Maghrib)</Text>
              <Text style={styles.description}>
              It is five rakahs in total. First, three obligatory rakahs, and then two sunnah rakahs are performed.              </Text>
            </View>
...
I intend to offer the _____ rakats of the ____ prayer. So you could say something along the lines, “I intend to offer the 3 rakats fardh of the Maghrib prayer” .Standing Straight.
              </Text>
        ...
        return (
          ...
          <ScrollView style={styles.scrollView}>
            ...
            <View style={styles.stepContainer}>
              ...
              <Image source={require('../../pic/prayer5.png')} style={styles.image3} />
              <Button title="Play Audio" onPress={prayer7} /> 
              <Text style={styles.description}>Since this is the last rakat, sit back up and finish the prayer </Text>
            </View>
            ...
            <View style={styles.stepContainer}>
              <Text style={styles.text}>Step 10:Ending the 3 rakats</Text>
              <Text style={styles.description}>
      ...
      case 5:
        return (
          ...
          <ScrollView>
            <View style={styles.container}>
              <Text style={styles.title}>Full 3 Rakat Prayer Example</Text>
              <Text style={styles.description}>
                This is an example of the full 3 rakat prayer. with different quran passages.
              </Text>
              <Button title="Play Audio" onPress={prayer15} />  
            </View>
          </ScrollView>
            <Button title="Previous" onPress={() => setStep(step - 1)} />
          </View>
